...
class _CalendarAppBarState extends State<CalendarAppBar> {
  ...
  void initState() {
    setState(() {
      ...
      ///initializing position to today
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance?.addPostFrameCallback((_) {
      double widthUnit = MediaQuery.of(context).size.width / 6 - 3.33;
      if (position > 5) {
        scrollController.animateTo(
          widthUnit * (position - 5),
        ...
        child: NotificationListener(
          onNotification: (dynamic notification) {
            ...
            if (notification is UserScrollNotification &&
              ...
              ///compare last selected date with curren selected date
              ...
              itemBuilder: (context, index) {
                ...
                return Padding(
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      width: MediaQuery.of(context).size.width / 6 - 3.33,
                      child: Align(
